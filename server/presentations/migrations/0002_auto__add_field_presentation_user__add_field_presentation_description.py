...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Presentation.user'
        db.add_column(u'presentations_presentation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Presentation.description'
        db.add_column(u'presentations_presentation', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Presentation.user'
        db.delete_column(u'presentations_presentation', 'user_id')

        # Deleting field 'Presentation.description'
        db.delete_column(u'presentations_presentation', 'description')
